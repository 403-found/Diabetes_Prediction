...
df = pd.read_csv(r'C:\Users\ghata\OneDrive\Desktop\diabetes_prediction-master\diabetes.csv')

# Page Configuration
st.set_page_config(page_title='Diabetes Prediction', page_icon=':hospital:', layout='wide')

# Sidebar Design
st.sidebar.image(r'C:\Users\ghata\OneDrive\Desktop\diabetes_prediction-master\diabetes-logo.png', use_column_width=True)
